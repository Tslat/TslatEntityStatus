...
public interface TESParticle<D> {
	 ...
	 * The {@link MatrixStack} has already been transformed relative to the player's camera at this stage.
	 */
	void render(MatrixStack poseStack, Minecraft mc, FontRenderer fontRenderer, float partialTick);
	 ...
	 */
	default void defaultedTextRender(Minecraft mc, MatrixStack poseStack, Vector3f prevPos, Vector3f pos, float partialTick, Runnable renderCallback) {

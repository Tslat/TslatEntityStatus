...
/**
 * Interface for TES' configurable settings.
...
public final class TESConfig {
	...
	/**
	 * Gets the tick-value for how frequently TES should clean up its {@link TESEntityTracking#ENTITY_STATES state cache}
	 */

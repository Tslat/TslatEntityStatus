...
public class ColouredRectRenderHelper {
    ...
    public void renderForHud(TESHudRenderContext.InGuiArgs args, float x, float y) {
        ...
        guiGraphics.guiRenderState.addGuiElement(new RenderState(this.renderPipeline, TextureSetup.noTexture(), new Matrix3x2f(guiGraphics.pose()), xMin, yMin, xMax, yMax,
